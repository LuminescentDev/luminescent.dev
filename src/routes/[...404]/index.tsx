    ...
    <section class="flex mx-auto max-w-6xl px-6 items-center" style={{ minHeight: 'calc(100dvh - 64px)' }}>
      <div class="text-left space-y-5">
        ...
        <div class="grid sm:flex gap-3 pt-4">
          <Link href="/" class="flex justify-center sm:justify-start transition duration-200 rounded-2xl shadow-lg backdrop-blur-lg bg-luminescent-900/60 hover:bg-luminescent-900/80 border border-luminescent-900 px-6 py-3 font-bold text-purple-100 md:py-4 md:px-8 text-sm md:text-lg whitespace-nowrap gap-4 items-center">
            Go back home
          </Link>
        </div>
      </div>
